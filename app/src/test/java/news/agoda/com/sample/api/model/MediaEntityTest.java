...
public class MediaEntityTest {
    ...
    @ParameterizedTest
    @MethodSource("inputTestMediaCopyright")
    public void testMediaCopyright(String copyright1) {
        Mockito.when(mediaEntity.getCopyright()).thenReturn(copyright);
        Assert.assertEquals(copyright1, mediaEntity.getCopyright());
    }

    private static Stream<Arguments> inputTestMediaCopyright() {
        return Stream.of(Arguments.of("testing copyright"), Arguments.of("testing copyright1"));
    }
